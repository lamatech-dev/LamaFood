...
2. **P2 — category identity and English alignment:** initial reference implementation kept category number on the wrong side and mechanically mirrored English title alignment. Fixed by putting the number at the outer trailing position for English and the right for Persian, with natural English heading alignment; desktop headings remain centered.
