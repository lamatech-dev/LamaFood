...
<aside class="admin-sidebar">
    ...
    <nav><button class="active">نمای کلی</button><button data-section-link="menu">منوی دیجیتال</button><button disabled>محتوا <small>مرحله بعد</small></button><button disabled>رسانه</button><button disabled>QR و آمار</button></nav>
